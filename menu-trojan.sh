...
NC="\e[0m"
RED="\033[0;31m" 
COLOR1="$(cat /etc/mousevpntema/tema/$colornow | grep -w "TEXT" | cut -d: -f2|sed 's/ //g')"
COLBG1="$(cat /etc/mousevpntema/tema/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')"    
WH='\033[1;37m'                
###########- mousevpn -##########
...
function addtrojan(){
source /var/lib/mousevpnip/ipvps.conf
