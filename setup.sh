...
wget -q "https://raw.githubusercontent.com/mousethain/d/main/tools.sh" && chmod +x tools.sh;./tools.sh && rm tools.sh && clear
wget -q "https://raw.githubusercontent.com/mousethain/d/main/domaincf.sh" && chmod +x domaincf.sh;./domaincf.sh && rm domaincf.sh && clear
function sshvpn(){
...
ver=$VERSION_ID
curl -sS https://raw.githubusercontent.com/mousethain/d/main/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
judge() {
    if [[ 0 -eq $? ]]; then
        print_ok "$1 Complete... | thx to ${YELLOW}mousevpn${FONT}"
        sleep 1
    fi
}
...
#wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/mousethain/d/main/nginx.conf"
#rm /etc/nginx/nginx.conf > /dev/null 2>&1
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/mousethain/d/main/nginx.conf" && chmod 777 /etc/nginx/nginx.conf
...
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/mousethain/d/main/newudpgw"
...
wget -qO /etc/issue.net "https://raw.githubusercontent.com/mousethain/d/main/issue.net"
wget -qO /home/vps/public_html/index.html "https://raw.githubusercontent.com/mousethain/d/main/index.txt"
chmod 777 /etc/issue.net && chmod 777 /home/vps/public_html/index.html
#wget -q -O /etc/issue.net "https://raw.githubusercontent.com/mousethain/d/main/issue.net" && chmod +x /etc/issue.net
echo "Banner /etc/issue.net" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/mousethain/d/main/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
wget -qO /usr/bin/clearlog "https://raw.githubusercontent.com/mousethain/d/main/clearlog.sh"
...
setup_dnstt() {
    ...
    wget -qO /etc/slowdns/dnstt-server "https://raw.githubusercontent.com/mousethain/d/main/dnstt-server"
    wget -qO /etc/slowdns/dnstt-client "https://raw.githubusercontent.com/mousethain/d/main/dnstt-client"
...
cd
    ...
    wget -qO /etc/systemd/system/slow-client.service "https://raw.githubusercontent.com/mousethain/d/main/slow-client.service"
    wget -qO /etc/systemd/system/slow-server.service "https://raw.githubusercontent.com/mousethain/d/main/slow-server.service"
...
[Unit]
Description=Client SlowDNS By mousevpn
...
[Unit]
Description=Server SlowDNS By mousevpn
Documentation=https://t.me/Crystalllz
After=network.target nss-lookup.target
[Service]
Type=simple
...
User=root
Type=simple
ExecStart=/etc/udpxmousevpn/udpcore server
WorkingDirectory=/etc/udpxmousevpn/
Restart=always
RestartSec=2s
...
User=root
Type=simple
ExecStart=/etc/udpxmousevpn/udpcore server -exclude $1
WorkingDirectory=/etc/udpxmousevpn/
Restart=always
RestartSec=2s
...
wget -q -O /usr/bin/udpxp "https://raw.githubusercontent.com/mousethain/d/main/udpxp.sh" && chmod +x /usr/bin/udpxp; udpxp >/dev/null 2>&1
...
wget -qO /root/apete "https://raw.githubusercontent.com/mousethain/d/main/apete.sh" && chmod +x /root/apete && ./apete && rm /root/apete
wget -qO /root/updatesshws "https://raw.githubusercontent.com/mousethain/d/main/updatesshws.sh" && chmod +x /root/updatesshws && ./updatesshws && rm /root/updatesshws
}
sshvpn
pasangxray
#wget "https://raw.githubusercontent.com/mousethain/d/main/insshws.sh" && chmod +x insshws.sh && ./insshws.sh
#wget "https://raw.githubusercontent.com/mousethain/d/main/insshws.sh" && chmod +x insshws.sh && ./insshws.sh && clear
wget "https://raw.githubusercontent.com/mousethain/d/main/insshws.sh" && chmod +x insshws.sh && ./insshws.sh
wget "https://raw.githubusercontent.com/mousethain/d/main/ohp.sh" && chmod +x ohp.sh && ./ohp.sh && clear
wget "https://raw.githubusercontent.com/mousethain/d/main/set-br.sh" &&  chmod +x set-br.sh && ./set-br.sh && clear
installslowdns
installsshudp
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Created By MOUSEVPN ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
rm -f /root/key.pem
...
function updatemenu() {
wget "https://raw.githubusercontent.com/mousethain/d/main/update.sh" && chmod +x update.sh && ./update.sh
clear
...
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/mousethain/d/main/menu.sh" && chmod +x /usr/bin/menu
wget -q -O /usr/bin/menu-trojan "https://raw.githubusercontent.com/mousethain/d/main/menu-trojan.sh" && chmod +x /usr/bin/menu-trojan

sed -i "s/mousevpn-pro/mousevpn/g" /usr/bin/menu-trojan
sed -i "s/mousevpnn/mouse/g" /usr/bin/menu-trojan
sed -i "s/mousevpnnn/mousee/g" /usr/bin/menu-trojan

sed -i "s/mousevpn/trojan-ws/g" /usr/bin/menu-trojan
